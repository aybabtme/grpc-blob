...
var _ service.BloberServer = (*GogoFastGRPCBlober)(nil)

type GogoFastGRPCBlober struct {
	FS blober.Blober
}

func (b *GogoFastGRPCBlober) Put(ctx context.Context, req *service.PutReq) (*service.PutRes, error) {
...
func (b *GogoFastGRPCBlober) Get(ctx context.Context, req *service.GetReq) (*service.GetRes, error) {
...
func (b *GogoFastGRPCBlober) Write(srv service.Blober_WriteServer) error {
	ctx := srv.Context()
	req, err := srv.Recv()
	if err == io.EOF {
		return nil
...
func (b *GogoFastGRPCBlober) Read(req *service.ReadReq, srv service.Blober_ReadServer) error {
	ctx := srv.Context()
