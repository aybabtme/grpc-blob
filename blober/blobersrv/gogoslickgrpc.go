...
var _ service.BloberServer = (*GogoSlickGRPCBlober)(nil)

type GogoSlickGRPCBlober struct {
	FS blober.Blober
}

func (b *GogoSlickGRPCBlober) Put(ctx context.Context, req *service.PutReq) (*service.PutRes, error) {
...
func (b *GogoSlickGRPCBlober) Get(ctx context.Context, req *service.GetReq) (*service.GetRes, error) {
...
func (b *GogoSlickGRPCBlober) Write(srv service.Blober_WriteServer) error {
	ctx := srv.Context()
	req, err := srv.Recv()
	if err == io.EOF {
		return nil
...
func (b *GogoSlickGRPCBlober) Read(req *service.ReadReq, srv service.Blober_ReadServer) error {
	ctx := srv.Context()
